...
// @version      1.0
// @description  Enhanced sidebar for Torn City
...
// @resource     ICON_EDIT     https://raw.githubusercontent.com/your-repo/icons/edit.png
// @resource     ICON_DELETE   https://raw.githubusercontent.com/your-repo/icons/delete.png
// @resource     ICON_CLOSE    https://raw.githubusercontent.com/your-repo/icons/close.png
...
(function() {
    ...
    // Resource URL handler to replace chrome.runtime.getURL
    const getResourceURL = (resourceName) => {
        switch(resourceName) {
            case 'icons/edit.png':
                return GM_getResourceURL('ICON_EDIT');
            case 'icons/delete.png':
                return GM_getResourceURL('ICON_DELETE');
            case 'icons/close.png':
                return GM_getResourceURL('ICON_CLOSE');
            default:
                return resourceName;
        }
    };
    ...
    const SVG_RESOURCES = {
        ...
        add_white: 'data:image/svg+xml;base64,',
        ...
        calculator: 'data:image/svg+xml;base64,',
        ...
        design_services_24dp_1F1F1F_FILL0_wght400_GRAD0_opsz24: 'data:image/svg+xml;base64,',
        done: 'data:image/svg+xml;base64,',
        edit_mode: 'data:image/svg+xml;base64,',
        menu: 'data:image/svg+xml;base64,',
        menu_open_32dp_CCC_FILL0_wght400_GRAD0_opsz40: 'data:image/svg+xml;base64,',
...

{
    ...
    const state = {
        ...
        isAutoWidth: GM_getValue('sidebarAutoWidth') !== '0',
        debugMenuOpen: false,
        currentPage: 0,
        pageData: [],
        clockVisible: false,
    ...
    const utils = {
        getSidebarWidth: () => {
                ...
                return new Promise(resolve => {
                    requestAnimationFrame(() => {
                        ...
                        if (!state.isEditMode) {
                            ...
                            GM_setValue('sidebarWidth', finalWidth);
                            resolve(finalWidth);
                            return;
                        }
            ...
            return parseInt(GM_getValue('sidebarWidth')) || CONSTANTS.SIDEBAR_WIDTH;
        },
        ...
        saveState: (key, value) => {
            ...
            GM_setValue(key, valueToStore);
            GM_setValue(`${key}_updatedAt`, Date.now());
            const currentValue = GM_getValue(key);
            if (currentValue) GM_setValue(`${key}_backup`, currentValue);
            return true;
        },
    ...
    const dom = {
        ...
        createDeleteButton: (theme, label = '', onClick) => {
            ...
            img.src = getResourceURL(SVG_RESOURCES.X);
            img.alt = 'Delete';
    ...
    async function loadEmojiPicker(containerId, theme) {
        ...
        `;
        try {
            const text = await fetch(getResourceURL("assets/emoji-test.txt")).then(r => r.text());
...
const components = {
    ...
    createToggleButton: (sidebar) => {
        ...
        const img = document.createElement('img');
        img.src = getResourceURL(SVG_RESOURCES.menu);
        img.alt = 'Menu';
        ...
        const savedBtnPos = GM_getValue('sidebarBtnPos') || 'top-left';
    ...
    createTopBar: () => {
        ...
        {
            id: 'clockButton',
            icon: `<img src="${getResourceURL(SVG_RESOURCES.clock)}" alt="Clock" style="width:20px;height:20px;vertical-align:middle;pointer-events: none;">`,
            color: '#444444',
        ...
        {
            id: 'calculatorButton',
            icon: `<img src="${getResourceURL(SVG_RESOURCES.calculator)}" alt="Calculator" style="width:20px;height:20px;vertical-align:middle;pointer-events: none;">`,
            color: '#444444',
        ...
        {
            id: 'deleteButton',
            icon: `<img src="${getResourceURL(SVG_RESOURCES.delete_mode)}" alt="Delete" style="width:20px;height:20px;vertical-align:middle;">`,
            color: theme.DANGER,
        ...
        {
            id: 'editButton',
            icon: `<img src="${getResourceURL(SVG_RESOURCES.edit_mode)}" alt="Edit" style="width:20px;height:20px;vertical-align:middle;">`,
            color: '#444444',
        ...
        {
            id: 'addButton',
            icon: `<img src="${getResourceURL(SVG_RESOURCES.add)}" alt="Add" style="width:32px;height:32px;vertical-align:middle;">`,
            color: theme.SUCCESS,
    ...
    createPageSelector: (theme) => {
        ...
        const img = document.createElement('img');
        img.src = getResourceURL(SVG_RESOURCES.pages);
        img.alt = 'Pages';
...
function addSidebarResizer() {
    ...
    resizer.addEventListener('mousedown', (e) => {
        ...
        function onMouseUp(ev) {
            ...
            let newWidth = Math.max(180, startWidth + dx);
            newWidth = Math.min(newWidth, window.innerWidth - 40);
            GM_setValue('sidebarWidth', newWidth);
...
function refreshSidebar() {
    ...
    try {
        ...
        try {
            ...
            const loanTrackerState = GM_getValue(`${CONSTANTS.STATE_KEYS.LOAN_TRACKER}_${state.currentPage}`);
            ...
            const auctionTrackerState = GM_getValue(`${CONSTANTS.STATE_KEYS.AUCTION_TRACKER}_${state.currentPage}`);
...
function createGroupHeader(group, index, theme, secondaryColor) {
    ...
    const img = document.createElement('img');
    img.src = getResourceURL(SVG_RESOURCES.add_white);
    img.alt = 'Add';
    img.style.cssText = `width: 12px; height: 12px; vertical-align: middle;`;
    ...
    if (state.isEditMode) {
        ...
        const img = document.createElement('img');
        img.src = getResourceURL(SVG_RESOURCES.color_selection);
...
function createNotepadElement(notepad, index) {
    ...
    penIcon.src = getResourceURL(SVG_RESOURCES.pen);
    penIcon.alt = 'Edit';
    ...
    if (state.isEditMode) {
        ...
        colorImg.src = getResourceURL(SVG_RESOURCES.color_selection);
...
function createAttackListHeader(list, index, theme, secondaryColor) {
    ...
    imgAddTarget.src = getResourceURL(SVG_RESOURCES.add_white);
    ...
    imgCurrentUser.src = getResourceURL(SVG_RESOURCES.pin);
...
function createTargetElement(target, list, listIndex, targetIndex, theme, secondaryColor) {
    ...
    imgSword.src = getResourceURL(SVG_RESOURCES.attack);
    imgSword.alt = 'Attack';
...
function createTodoListHeader(list, index, theme, secondaryColor) {
    ...
    imgAdd.src = getResourceURL(SVG_RESOURCES.add_white);
    imgAdd.alt = 'Add';
...
function createLoanEntryElement(entry, index, theme, secondaryColor) {
    ...
    userText.innerHTML = `<strong> <img src="${getResourceURL(SVG_RESOURCES.pin)}" alt="Seller" style="height:12px;vertical-align:left;"> ${entry.user}</strong>`;
...
function createAuctionElement(auction, index, theme, secondaryColor) {
    ...
    imgItem.src = getResourceURL(SVG_RESOURCES.tag);
    imgItem.alt = 'Item';
    ...
    imgSeller.src = getResourceURL(SVG_RESOURCES.pin);
    ...
    function updateTime() {
        ...
        imgTimer.src = getResourceURL(SVG_RESOURCES.timer);
        imgTimer.alt = 'Timer';
    ...
    imgSearch.src = getResourceURL(SVG_RESOURCES.search);
    imgSearch.alt = 'Add';
...
function createCountdownHeader(group, index, theme, secondaryColor) {
    ...
    imgAddTimer.src = getResourceURL(SVG_RESOURCES.add_white);
    imgAddTimer.alt = 'Add';
...
function updateSidebarBtnPosition(position) {
    ...
    GM_setValue('sidebarBtnPos', position);
    requestAnimationFrame(() => {
...
function addDebugManager() {
    ...
    settingsIcon.src = getResourceURL(SVG_RESOURCES.settings);
...
function showDebugMenu() {
    ...
    if (autoWidthCheckbox) {
        ...
        autoWidthCheckbox.addEventListener('change', async (e) => {
            ...
            GM_setValue('sidebarAutoWidth', state.isAutoWidth ? '1' : '0');

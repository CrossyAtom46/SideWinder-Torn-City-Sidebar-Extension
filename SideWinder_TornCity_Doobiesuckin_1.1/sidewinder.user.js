            ...
            try {
                if (operation === 'get') {
                    ...
                    if (typeof data === 'object' && !Array.isArray(data)) {
                        ...
                        console.warn("safeStorage: 'set' expects an object");
                        return false;
                    }
                    ...
                    console.warn(`safeStorage: unknown operation '${operation}'`);
                    return false;
                }
            } catch (err) {
    ...
    const components = {
        ...
        createToggleButton: (sidebar) => {
            ...
            toggleButton.addEventListener('click', () => {
                ...
                requestAnimationFrame(() => {
                    sidebar.style.transform = newHiddenState ?
                        `translateX(${state.isSidebarRight ? '-102%' : '-102%'})` :
                        'translateX(0)';
        ...
        createTopBar: () => {
            ...
            const buttons = [{
                    id: 'clockButton',
                    icon: `<img src="${SVG_RESOURCES.clock}" alt="Clock" style="width:20px;height:20px;vertical-align:middle;pointer-events: none;">`,
                    color: '#444444',
                ...
                {
                    id: 'calculatorButton',
                    icon: `<img src="${SVG_RESOURCES.calculator}" alt="Calculator" style="width:20px;height:20px;vertical-align:middle;pointer-events: none;">`,
                    color: '#444444',
                ...
                {
                    id: 'deleteButton',
                    icon: `<img src="${SVG_RESOURCES.delete_mode}" alt="Delete" style="width:20px;height:20px;vertical-align:middle;">`,
                    color: theme.DANGER,
                ...
                {
                    id: 'editButton',
                    icon: `<img src="${SVG_RESOURCES.edit_mode}" alt="Edit" style="width:20px;height:20px;vertical-align:middle;">`,
                    color: '#444444',
                ...
                {
                    id: 'addButton',
                    icon: `<img src="${SVG_RESOURCES.add}" alt="Add" style="width:32px;height:32px;vertical-align:middle;">`,
                    color: theme.SUCCESS,
...
${dom.createDialogButtons(theme)}
    ...
    function createGroupHeader(group, index, theme, secondaryColor) {
        ...
        const img = document.createElement('img');
        img.src = SVG_RESOURCES.add_white;
        img.alt = 'Add';
        img.style.cssText = `width: 12px; height: 12px; vertical-align: middle;`;
        ...
        if (state.isEditMode) {
            ...
            const img = document.createElement('img');
            img.src = SVG_RESOURCES.color_selection;
    ...
    `;
        ...
        if (state.isEditMode) {
            ...
            colorImg.src = SVG_RESOURCES.color_selection;
    ...
    function createAttackListHeader(list, index, theme, secondaryColor) {
        ...
        imgAddTarget.src = SVG_RESOURCES.add_white;
        ...
        imgCurrentUser.src = SVG_RESOURCES.pin;
    ...
    function createTargetElement(target, list, listIndex, targetIndex, theme, secondaryColor) {
        ...
        imgSword.src = SVG_RESOURCES.attack;
        imgSword.alt = 'Attack';
    ...
    function createTodoListHeader(list, index, theme, secondaryColor) {
        ...
        imgAdd.src = SVG_RESOURCES.add_white;
        imgAdd.alt = 'Add';
    ...
    function createLoanEntryElement(entry, index, theme, secondaryColor) {
        ...
        userText.innerHTML = `<strong> <img src="${SVG_RESOURCES.pin}" alt="Seller" style="height:12px;vertical-align:left;"> ${entry.user}</strong>`;
    ...
    function createAuctionElement(auction, index, theme, secondaryColor) {
        ...
        imgSeller.src = SVG_RESOURCES.pin;
        ...
        function updateTime() {
            ...
            imgTimer.src = SVG_RESOURCES.timer;
            imgTimer.alt = 'Timer';
        ...
        imgSearch.src = SVG_RESOURCES.search;
        imgSearch.alt = 'Add';
    ...
    function createCountdownHeader(group, index, theme, secondaryColor) {
        ...
        imgAddTimer.src = SVG_RESOURCES.add_white;
        imgAddTimer.alt = 'Add';
    ...
    `;
        ...
        settingsIcon.src = SVG_RESOURCES.settings;
...
`;
    ...
    function init() {
        try {
            ...
            addDebugManager();
            addResizerStyles();
            window.addEventListener((request, sender, sendResponse) => {
                try {
